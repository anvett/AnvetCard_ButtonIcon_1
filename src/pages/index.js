      ...
      <Container fluid className={styles.mainContainer}>
        ...
        <Row>
          <Col className={styles.services}>
            <Services
              services={[
                {
                  service: "Cirugía general avanzada",
                  role: "Cirujano general",
                  description:
                    "Especializado en una amplia gama de procedimientos quirúrgicos, el Dr. Carlos Veintimilla aplica técnicas avanzadas y mínimamente invasivas para tratar diversas condiciones. Su enfoque se centra en la seguridad del paciente, la precisión quirúrgica y una recuperación rápida y efectiva.",
                },
                {
                  service: "Gestión y Administración Hospitalaria",
                  role: "Administrador Hospitalario",
                  description:
                    " Con una sólida formación en administración hospitalaria, el Dr. Carlos Veintimilla lidera con eficacia la gestión de recursos, la optimización de servicios y la mejora continua de la calidad asistencial, garantizando la excelencia en la atención al paciente.",
                },
                {
                  service: "Consultoría en Cirugía y Tratamientos",
                  role: "Consultor Médico",
                  description:
                    "El Dr. Carlos Veintimilla ofrece consultoría experta en opciones de tratamiento quirúrgico, proporcionando evaluaciones detalladas y recomendaciones personalizadas para asegurar los mejores resultados de salud para sus pacientes.",
                },
                {
                  service: "Educación y Formación Médica",
                  role: "Educador y Mentor",
                  description:
                    "Comprometido con la formación de la próxima generación de médicos, el Dr. Carlos Veintimilla imparte conocimientos en cirugía y administración hospitalaria, combinando experiencia práctica con teoría avanzada para enriquecer el aprendizaje médico.",
                },
              ]}
            />
          </Col>
        ...
        <Row>
          <Col className={styles.qrCode}>
            <section id="qrCode">
              <QRCodeComponent qrCodeImageUrl="/images/qrcode.png" altText="QR Code" />
            </section>
          </Col>
        </Row>
      </Container>
